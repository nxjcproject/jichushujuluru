...
<body>
    <div class="easyui-layout" data-options="fit:true,border:false" style="padding: 5px;">
        ...
        <div data-options="region:'west',collapsible:false" style="width:880px;">
            ...
            <table class="table" style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 150px;">
                        <input id="TextBox_MasterVariableName" class="easyui-textbox" data-options="required:true,missingMessage:'不能为空', editable:false" style="width: 140px;" /></td>
