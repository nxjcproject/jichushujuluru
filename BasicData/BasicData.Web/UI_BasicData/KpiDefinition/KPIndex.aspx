<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPIndex.aspx.cs" Inherits="BasicData.Web.UI_BasicData.KpiDefinition.KPIndex" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript"src="../js/page/KpiDefinition/KPIndex.js"charset="utf-8"></script>
</head>
<body>
...
<%--        <div data-options="region:'west',border:false " style="width: 230px;">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td >标准类型</td>
                                <td style="width: 90px;">
                                    <input id="txt_StandardType"class="easyui-combobox" style="width: 80px;"data-options="panelHeight:'auto'" />
                                </td>  
                                <td style="width: 110px;">
     ...
     <!-- KPI详细添加窗口开始 -->
    <div id="dlgKPIndexDetailEditor" class="easyui-dialog" title="KPI指标添加" data-options="modal:true,closed:true,iconCls:'icon-edit',minimizable:false,maximizable:false,collapsible:false,resizable:false,buttons:'#bbKPIndexDetailEditor'" style="width:400px;height:auto;padding:10px 60px 20px 60px">
	    <table>
             <tr>
	    		<td>项目名称：</td>
	    	...
	    	<tr>
	    		<td>组织机构：</td>
                <td><input class="easyui-combotree" type="text" id="KPIndexOrganization" data-options="panelHeight: 'auto',required:true" style="width:140px" /><label id="Lab_warning"></label></td>
	    	</tr>
	    	<tr>
	    		<td>项目：</td>
	...
	<div id="bbKPIndexDetailEditor">
	    ...
	    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="$('#dlgKPIndexDetailEditor').dialog('close');">取消</a>
	</div>
