    ...
    public partial class KPIndex : WebStyleBaseForEnergy.webStyleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //this.OrganisationTree.PageName = "KPIndexEnergy.aspx";                                     //向web用户控件传递当前调用的页面名称
            }
        }
        /// <summary>
        /// 增删改查权限控制
        ...
        [WebMethod]
        public static void AddKPIndexEnergy(string mStandardLevel, string mEnergyType, string mObjName, string mOrganizationId, string mLevelType, string mVariableId, string mValueType, string mtype, string mUnit, float mStandardValue, string mLevel, string mCreator)
        {
